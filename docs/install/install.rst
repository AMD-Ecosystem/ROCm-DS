...
* `hipRAFT Installation instructions <https://rocm.docs.amd.com/projects/hipRAFT-internal/en/latest/install/install.html>`__
* `hipVS Installation instructions <https://rocm.docs.amd.com/projects/hipvs-internal/en/latest/install/install.html>`__
* `dask-hip Installation instructions <https://rocm.docs.amd.com/projects/dask-hip-internal/en/latest/install/install.html>`__
* `hip-ucxx Installation instructions <https://rocm.docs.amd.com/projects/hip-ucxx-internal/en/latest/install/install.html>`__
